...
- Keep Google/Apple OAuth and Delete Account flows visible but add TODO documentation.
...
Unimplemented actions should remain visible to preserve perceived capability during MVP validation, but code should clearly mark these gaps as TODOs. This ensures engineering follow-through without altering UI behavior in this round.
...
- Unimplemented actions are documented as TODOs without UX changes.
